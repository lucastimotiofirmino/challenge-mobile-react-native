...
async function GetListEvents(id: Number): Promise<InterfaceReturn> {
	...
	try {
		const response = await ApiMarvelPublic.get(`events/${id}?ts=${time}&apikey=${apiKeyPublic}&hash=${hash}`)
